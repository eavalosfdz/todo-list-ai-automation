        ...
        <div className={`rounded-lg shadow-lg p-6 transition-colors duration-200 ${darkMode ? 'bg-gray-800 text-white' : 'bg-white text-gray-800'
          ...
          <div className="flex items-center justify-between mb-8">
            <div className="flex items-center gap-3">
              ...
              <div className={`px-3 py-1 rounded-full text-sm font-medium ${darkMode ? 'bg-blue-600 text-white' : 'bg-blue-100 text-blue-800'
                }`}>
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className={`px-3 py-2 rounded-lg transition-colors duration-200 ${darkMode ? 'bg-red-600 hover:bg-red-700' : 'bg-red-500 hover:bg-red-600'
              ...
              <div className="mb-3">
                ...
                <div className="relative">
                  <input
                    ...
                    placeholder="Title"
                    className={`w-full px-4 py-3 pr-12 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors duration-200 ${darkMode
                  ...
                  <button
                    ...
                    className={`absolute right-2 top-1/2 transform -translate-y-1/2 p-1.5 rounded-md transition-colors ${darkMode
                      ? 'text-gray-400 hover:text-blue-400 hover:bg-gray-500'
                      : 'text-gray-500 hover:text-blue-600 hover:bg-gray-100'
                      }`}
                    title="Get AI help creating your todo"
                  >
                  ...
                  {titleFocused && (
                    <button
                      ...
                      className={`absolute -top-12 left-0 right-0 z-10 px-3 py-2 rounded-lg shadow-lg border transition-all duration-200 cursor-pointer hover:shadow-xl ${darkMode
                    ...
                    >
                      ...
                      {/* Tooltip arrow */}
                      <div className={`absolute top-full left-4 w-0 h-0 border-l-4 border-r-4 border-t-4 border-transparent ${darkMode ? 'border-t-gray-800' : 'border-t-white'
                        }`}></div>
                    </button>
                  )}
                </div>
                ...
                >
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      {todo.priority && (
                        <span className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium border ${darkMode
                          ? 'bg-red-500/20 text-red-300 border-red-400/30 shadow-sm'
                    ...
                    >
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-1">
                          ...
                          {todo.priority && (
                            <span className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium border ${darkMode
                              ? 'bg-red-500/15 text-red-400 border-red-400/25 shadow-sm opacity-75'
                              : 'bg-red-100 text-red-800 border-red-200'
                              }`}>
                              <svg className="w-3 h-3 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                <path fillRule="evenodd" d="M3 4a1 1 0 011-1h12a1 1 0 011 1v2a1 1 0 01-1 1H4a1 1 0 01-1-1V4zM3 10a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H4a1 1 0 01-1-1v-6zM14 9a1 1 0 00-1 1v6a1 1 0 001 1h2a1 1 0 001-1v-6a1 1 0 00-1-1h-2z" clipRule="evenodd" />
